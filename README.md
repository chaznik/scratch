...
5. Run command: java -jar target/scratch-1.0-SNAPSHOT.jar --config <path-to-config-file> --betting-amount 100
6. Please note config is currently located at src/main/resources/config.json
